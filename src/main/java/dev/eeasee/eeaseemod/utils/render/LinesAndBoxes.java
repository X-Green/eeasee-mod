...
import dev.eeasee.eeaseemod.utils.PositionUtils;
...
public class LinesAndBoxes {
    ...
    public static void drawLine(Vec3i v1, Vec3i v2, Color color, float lineWidth) {
        drawLine(v1.getX() + 0.5, v1.getY() + 0.5, v1.getZ() + 0.5, v2.getX() + 0.5, v2.getY() + 0.5, v2.getZ() + 0.5, color, lineWidth);
    }

    public static void drawLine(Vec3d v1, Vec3d v2, Color color, float lineWidth) {
        drawLine(v1.getX(), v1.getY(), v1.getZ(), v2.getX(), v2.getY(), v2.getZ(), color, lineWidth);
    }

    public static void drawBoxOutlined(Vec3i v1, Vec3i v2, Color color, float lineWidth) {
        drawBoxOutlined(v1.getX() + 0.5, v1.getY() + 0.5, v1.getZ() + 0.5, v2.getX() + 0.5, v2.getY() + 0.5, v2.getZ() + 0.5, color, lineWidth);
    }

    public static void drawBoxOutlined(Vec3d v1, Vec3d v2, Color color, float lineWidth) {
        drawBoxOutlined(v1.getX() + 0.5, v1.getY() + 0.5, v1.getZ() + 0.5, v2.getX() + 0.5, v2.getY() + 0.5, v2.getZ() + 0.5, color, lineWidth);
    }
